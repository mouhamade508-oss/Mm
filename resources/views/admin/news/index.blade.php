                    ...
                    @if($news->hasPages())
                        ...
                        <div class="pagination-wrapper">
                          <div class="pagination-controls">
                            ...
                            @else
                              <a href="{{ $news->appends(request()->query())->previousPageUrl() }}" class="pagination-btn animate">◀ السابق</a>
                            @endif
                            <span class="pagination-info">صفحة {{ $news->currentPage() }} من {{ $news->lastPage() }}</span>
                            @if($news->hasMorePages())
                              <a href="{{ $news->appends(request()->query())->nextPageUrl() }}" class="pagination-btn animate">التالي ▶</a>
                            @else
