                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select id="currency" name="currency" required 
                                ...
                                <option value="SYP" {{ old('currency', $product->currency ?? 'SYP') == 'SYP' ? 'selected' : '' }}>الليره السورية (ل.س)</option>
                                <option value="USD" {{ old('currency', $product->currency) == 'USD' ? 'selected' : '' }}>الدولار الأمريكي ($)</option>
                            </select>
                            @error('currency') 
                                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
