        ...
        @if($games->hasPages())
            ...
            <div class="pagination-wrapper">
              <div class="pagination-controls">
                ...
                @else
                  <a href="{{ $games->appends(request()->query())->previousPageUrl() }}" class="pagination-btn animate">◀ السابق</a>
                @endif
                <span class="pagination-info">صفحة {{ $games->currentPage() }} من {{ $games->lastPage() }}</span>
                @if($games->hasMorePages())
                  <a href="{{ $games->appends(request()->query())->nextPageUrl() }}" class="pagination-btn animate">التالي ▶</a>
                @else
