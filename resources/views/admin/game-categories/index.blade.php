        ...
        @if($categories->hasPages())
            ...
            <div class="pagination-wrapper">
              <div class="pagination-controls">
                ...
                @else
                  <a href="{{ $categories->appends(request()->query())->previousPageUrl() }}" class="pagination-btn animate">◀ السابق</a>
                @endif
                <span class="pagination-info">صفحة {{ $categories->currentPage() }} من {{ $categories->lastPage() }}</span>
                @if($categories->hasMorePages())
                  <a href="{{ $categories->appends(request()->query())->nextPageUrl() }}" class="pagination-btn animate">التالي ▶</a>
                @else
