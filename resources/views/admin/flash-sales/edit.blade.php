        ...
        <form method="POST" action="{{ route('admin.flash-sales.update', $flashSale) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="discount_percentage" id="discount_percentage" min="0" max="100" step="0.01" value="{{ old('discount_percentage', $flashSale->discount_percentage) }}" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
